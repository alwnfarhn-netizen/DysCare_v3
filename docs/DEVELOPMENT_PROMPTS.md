...
```
STATUS: SUPERSEDED. Keputusan akhir adalah mempertahankan 2 domain (reading dan spelling) tanpa domain comprehension terpisah, karena konsisten dengan Batasan Penelitian BAB I yang fokus pada early reading skills sebagai dua pilar Simple View of Reading (Gough & Tunmer, 1986). Comprehension sebagai komponen kedua sudah tercermin secara implisit pada soal level5 dan level6 (Membaca Kalimat dan Kelancaran Membaca). Lihat SDD.md REQ-ASMT-01 untuk detail pertimbangan.
