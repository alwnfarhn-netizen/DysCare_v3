...
/* --------------------------------------------------------------------------
   ...
   Memetakan 6 level secara langsung ke dataset L1-L6 di state.js.
   Referensi: SDD.md REQ-LVL-02
   -------------------------------------------------------------------------- */
 ...
 *
 * Menggantikan pemetaan 3-tier (Easy/Medium/Hard) sebelumnya.
 * Referensi: SDD.md REQ-LVL-02
 *
 * @returns {string[]}
 */
...
/**
 * Ambil pool kata mengeja sesuai level saat ini (1-6).
 *
 * Setiap level memiliki dataset terpisah (wordsL1-L6) yang berbeda
 * secara substansial, sesuai Task Analysis Bab III proposal berbasis
 * Simple View of Reading (Gough & Tunmer, 1986).
 *
 * Menggantikan pemetaan 3-tier (Easy/Medium/Hard) sebelumnya.
